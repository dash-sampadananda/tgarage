<?php echo form_open('jcline/add',array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="workname" class="col-md-4 control-label">Workname</label>
		<div class="col-md-8">
			<input type="text" name="workname" value="<?php echo $this->input->post('workname'); ?>" class="form-control" id="workname" />
		</div>
	</div>
	<div class="form-group">
